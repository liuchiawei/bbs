...
export const TRANSLATIONS = {
  en: {
    ...
    // Admin Management
    POSTS_MANAGEMENT: "Posts",
    EVENTS_MANAGEMENT: "Events",
    FIGHTERS_MANAGEMENT: "Fighters",
    ...
    POST_DELETED_PLACEHOLDER: "This post has been deleted",
    ...
    CATEGORY_SLUG_PLACEHOLDER: "Enter slug (optional)",
    CATEGORY_DESCRIPTION_PLACEHOLDER: "Enter description (optional)",
    DISPLAY_ORDER_REQUIRED: "Display order is required",
    DISPLAY_ORDER_INVALID:
      "Display order must be a positive integer (minimum 1)",
    CATEGORY_DELETE_WARNING:
      "Deleting this category will remove it from all posts. Posts will be set to 'No Category'.",
    ADD_CATEGORY_DESCRIPTION: "Create a new category for posts",
    EDIT_CATEGORY_DESCRIPTION: "Update category information",
    CATEGORY_IN_USE: "This category is in use by {count} posts",
    CREATE: "Create",
    VIEWS: "views",
    ...
    COMMENT_DELETED_PLACEHOLDER: "This comment has been deleted",
  ...
  ja: {
    ...
    CATEGORIES_MANAGEMENT: "カテゴリー",
    EVENTS_MANAGEMENT: "イベント",
    FIGHTERS_MANAGEMENT: "選手",
    FORUM_MANAGEMENT: "フォーラム管理",
    USER_MANAGEMENT_SECTION: "ユーザー管理",
    ...
    POST_DELETED_PLACEHOLDER: "この投稿は削除されました",
    ...
    CATEGORY_CREATED_SUCCESS: "カテゴリーが正常に作成されました",
    CATEGORY_UPDATED_SUCCESS: "カテゴリーが正常に更新されました",
    CATEGORY_DELETED_SUCCESS: "カテゴリーが正常に削除されました",
    FAILED_TO_CREATE_CATEGORY: "カテゴリーの作成に失敗しました",
    FAILED_TO_UPDATE_CATEGORY: "カテゴリーの更新に失敗しました",
    FAILED_TO_DELETE_CATEGORY: "カテゴリーの削除に失敗しました",
    FAILED_TO_LOAD_CATEGORIES: "カテゴリーの読み込みに失敗しました",
    NO_CATEGORIES_FOUND: "カテゴリーが見つかりません",
    CATEGORY_NAME_REQUIRED: "カテゴリー名は必須です",
    CATEGORY_NAME_PLACEHOLDER: "カテゴリー名を入力",
    CATEGORY_SLUG_PLACEHOLDER: "スラッグを入力（オプション）",
    CATEGORY_DESCRIPTION_PLACEHOLDER: "説明を入力（オプション）",
    DISPLAY_ORDER_REQUIRED: "表示順序は必須です",
    DISPLAY_ORDER_INVALID: "表示順序は1以上の整数である必要があります",
    CATEGORY_DELETE_WARNING:
      "このカテゴリーを削除すると、すべての投稿から削除されます。投稿は「カテゴリーなし」に設定されます。",
    ADD_CATEGORY_DESCRIPTION: "投稿用の新しいカテゴリーを作成",
    EDIT_CATEGORY_DESCRIPTION: "カテゴリー情報を更新",
    CATEGORY_IN_USE: "このカテゴリーは{count}件の投稿で使用されています",
    CREATE: "作成",
    VIEWS: "閲覧",
    ...
    COMMENT_DELETED_PLACEHOLDER: "このコメントは削除されました",
  ...
  "zh-CN": {
    ...
    EVENTS_MANAGEMENT: "赛事",
    FIGHTERS_MANAGEMENT: "选手",
    FORUM_MANAGEMENT: "讨论区管理",
    USER_MANAGEMENT_SECTION: "用户管理",
    ...
    POST_DELETED_PLACEHOLDER: "此文章已被删除",
    ...
    FAILED_TO_CREATE_CATEGORY: "创建分类失败",
    FAILED_TO_UPDATE_CATEGORY: "更新分类失败",
    ...
    CATEGORY_SLUG_PLACEHOLDER: "输入Slug（可选）",
    CATEGORY_DESCRIPTION_PLACEHOLDER: "输入描述（可选）",
    DISPLAY_ORDER_REQUIRED: "显示顺序为必填项",
    DISPLAY_ORDER_INVALID: "显示顺序必须是大于等于1的整数",
    CATEGORY_DELETE_WARNING:
      "删除此分类将从所有帖子中移除。帖子将被设置为「未分类」。",
    ADD_CATEGORY_DESCRIPTION: "为帖子创建新分类",
    EDIT_CATEGORY_DESCRIPTION: "更新分类信息",
    CATEGORY_IN_USE: "此分类正在被{count}个帖子使用",
    CREATE: "创建",
    VIEWS: "浏览",
    UPDATING_POST: "更新帖子中...",
    ...
    COMMENT_DELETED_PLACEHOLDER: "此评论已被删除",
  ...
  "zh-TW": {
    ...
    EVENTS_MANAGEMENT: "賽事",
    FIGHTERS_MANAGEMENT: "選手",
    FORUM_MANAGEMENT: "討論區管理",
    USER_MANAGEMENT_SECTION: "用戶管理",
    DATA_MANAGEMENT: "資料管理",
    TOTAL: "總計",
    AUTHOR: "作者",
    CREATED: "創建時間",
    ACTIONS: "操作",
    NO_EVENTS_FOUND: "未找到賽事",
    EVENTS: "賽事",
    FIGHTS: "對戰",
    BETS: "投注",
    DATE: "日期",
    ...
    POST_DELETED_PLACEHOLDER: "此文章已被刪除",
    ...
    CATEGORY_CREATED_SUCCESS: "分類建立成功",
    CATEGORY_UPDATED_SUCCESS: "分類更新成功",
    CATEGORY_DELETED_SUCCESS: "分類刪除成功",
    FAILED_TO_CREATE_CATEGORY: "建立分類失敗",
    FAILED_TO_UPDATE_CATEGORY: "更新分類失敗",
    FAILED_TO_DELETE_CATEGORY: "刪除分類失敗",
    FAILED_TO_LOAD_CATEGORIES: "載入分類失敗",
    NO_CATEGORIES_FOUND: "找不到分類",
    CATEGORY_NAME_REQUIRED: "分類名稱為必填項",
    CATEGORY_NAME_PLACEHOLDER: "輸入分類名稱",
    CATEGORY_SLUG_PLACEHOLDER: "輸入Slug（可選）",
    CATEGORY_DESCRIPTION_PLACEHOLDER: "輸入描述（可選）",
    DISPLAY_ORDER_REQUIRED: "顯示順序為必填項",
    DISPLAY_ORDER_INVALID: "顯示順序必須是大於等於1的整數",
    CATEGORY_DELETE_WARNING:
      "刪除此分類將從所有貼文中移除。貼文將被設置為「未分類」。",
    ADD_CATEGORY_DESCRIPTION: "為貼文建立新分類",
    EDIT_CATEGORY_DESCRIPTION: "更新分類資訊",
    CATEGORY_IN_USE: "此分類正在被{count}個貼文使用",
    CREATE: "建立",
    VIEWS: "查看",
    UPDATING_POST: "更新帖子中...",
    POST_UPDATED_SUCCESS: "帖子更新成功！",
    ...
    COMMENT_DELETED_PLACEHOLDER: "此評論已被刪除",
