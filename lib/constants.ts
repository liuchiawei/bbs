...
export const TRANSLATIONS = {
  en: {
    ...
    ALERT_NICKNAME_MIN_LENGTH: "Nickname must be at least 2 characters",
  ...
  ja: {
    ...
    ALERT_NICKNAME_MIN_LENGTH: "ニックネームは2文字以上である必要があります",
  ...
  "zh-CN": {
    ...
    ALERT_NICKNAME_MIN_LENGTH: "昵称必须至少2个字符",
  ...
  "zh-TW": {
    ...
    ALERT_NICKNAME_MIN_LENGTH: "暱稱至少需有2個字元",
