...
import PostCardFooter from "@/features/post/components/post-card-footer";
import { Card, CardContent } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";
import { toast } from "sonner";
import { useState, useEffect } from "react";
import type { PostWithUser, Category } from "@/lib/types";
  ...
  return (
    <Card className="hover:shadow-lg">
      <CardContent className="flex space-x-4 space-y-1">
        <PostCardHeader category={post.category as Category | null | undefined} />
